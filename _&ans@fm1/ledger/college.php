		...
		<div class="md:col-span-12">
			<div class="bg-white rounded-xl shadow-lg overflow-hidden">
				<div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
					<i class="icon-group"></i> College Ledger Transaction  
				</div>
				<div class="p-6">
					<form role="form" method="post">
						<div class="grid gap-6 md:grid-cols-12">
							...
							<div class="md:col-span-3 space-y-4">								
								<select name="lnrName" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 chzn-select" tabindex="2" placeholder="Please select learner...">
				...
				<div class="p-6">
					<div class="overflow-x-auto">
						<table class="w-full border-collapse" id="dataTables-example">
							...
							$counter=1;
							$temp="";
							$strQry="SELECT c.clid, c.syid, c.sid,o.cid, c.csid, cs.fname, cs.mname, cs.lname, c.amt,
									...
									where c.syid=".$csyid." and c.sid=".$cssid." and c.did=".$dept." 
