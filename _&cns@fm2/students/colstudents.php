...
<div class="inner">
	<form method="post" role="form" class="grid gap-4 grid-cols-2 md:grid-cols-12">
		...
		<div class="md:col-span-2">
			<select name="grade" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
				...
				<?php 
				$grdQry="SELECT gid, did, glevel FROM gradelevel where did=".$dept."";
		...
		<div class="md:col-span-3">
			<select name="program" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
				<option value="0" selected >Program Offerings</option>
				<?php 
	...
	if(isset($_POST['btnAdd'])){
		...
		if($fn=="" && $ln==""){
			...
			$strCheck="SELECT fname, mname, lname FROM students 
			           where fname='".$fn."' and mname='".$mn ."' and lname='".$ln."' and did=".$dept."";
			...
			<?php
				...
				$strInsert="Insert into students (studentid, syid, sid, cid, gid, fname, mname, lname, address, mobile,remarks,did) 
							values ('".$studId."',".$sy.",".$sem.",".$cid.",".$glevel.",
	...
	if(isset($_POST['btnUpload'])){
		...
		if(!empty($_FILES["image"]["name"])) { 
			...
			if(in_array($fileType, $allowTypes)){ 
				...
				$qryImg="Update students set pict='".$imgContent."', ftype ='".$fileType."' where csid='".$ucsid."'";
				//echo $qryImg;
	...
	if(isset($_POST['btnDelete'])){
		...
		if($dstatus=='Active'){
			...
			$qryDelete="Delete from students where csid=".$dcsid." and did=".$dept."";
		...
		<div class="md:col-span-12">
			<div class="bg-white rounded-xl shadow-lg overflow-hidden">
				<div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
					...
					<i class="icon-list"></i> List of College Learners for the School Year -<strong> <?php echo $s;?>  | Semester : <?php echo $cssemester;?></strong>
				</div>
				<div class="p-6">
