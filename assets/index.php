                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="chat-panel dropdown">
                       <a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<span class="label label-warning">User Name Here </span> &nbsp;
            ...
            <ul id="menu" class="collapse">                
                ...
                <li class="panel">
                    ...
                    <ul class="collapse" id="pagesr-nav">
                        <li><a href="pages_calendar.html"><i class="icon-angle-right"></i> School Year </a></li>
                        <li><a href="pages_timeline.html"><i class="icon-angle-right"></i> Semester </a></li>
                        <li><a href="pages_social.html"><i class="icon-angle-right"></i> Programs </a></li>
